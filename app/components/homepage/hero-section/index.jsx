        ...
        <div className="order-2 lg:order-1 flex flex-col items-start justify-center p-2 pb-20 md:pb-10 lg:pt-10">
          <h1 className="text-3xl font-bold leading-10 text-white md:font-extrabold lg:text-[2.6rem] lg:leading-[3.5rem]">
            ...
            <span className="text-[#16f2b3]">
              I'm a <strong className="text-blue-400">CS Major</strong> from{" "}
              <strong>NUS</strong> and an avid{" "}
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              className="flex items-center gap-1 hover:gap-3 rounded-full bg-gradient-to-r from-pink-400 to-violet-200 px-3 md:px-8 py-3 md:py-4 text-center text-xs md:text-sm font-medium uppercase tracking-wider text-white no-underline transition-all duration-200 ease-out hover:text-white hover:no-underline md:font-semibold"
              role="button"
              target="_blank"
          ...
          <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
            <code className="font-mono text-xs md:text-sm lg:text-base">
              <div className="blink">
                ...
                <span className="mr-2 text-white">saiUtkarsh</span>
              ...
              <div>
                ...
                <span className="text-gray-400">{`'`}</span>
                <span className="text-amber-300">Sai Utkarsh</span>
                <span className="text-gray-400">{`',`}</span>
              </div>
              ...
              <div className="ml-8 lg:ml-16">
                <span className="text-white">programmingSkills:</span>
                <span className="text-gray-400">{` ['`}</span>
              ...
              <div className="ml-8 lg:ml-16">
                ...
                <span className="text-gray-400">{"', '"}</span>
                <span className="text-amber-300">Parcel</span>
                <span className="text-gray-400">{"'],"}</span>
              </div>
              <div className="ml-8 lg:ml-16">
              ...
              <div className="ml-8 lg:ml-16">
                <span className="text-white">growthOriented:</span>
                <span className="text-orange-400">true</span>
              </div>
              <div className="ml-4 lg:ml-8">
                <span className="text-gray-400">{"},"}</span>
              ...
              <div className="ml-12 lg:ml-24">
                <span className="text-cyan-400">this.</span>
                <span className="mr-2 text-white">growthOriented</span>
                <span className="text-amber-300">&amp;&amp;</span>
              </div>
              <div className="ml-12 lg:ml-24">
                <span className="text-cyan-400">this.</span>
                <span className="mr-2 text-white">skills.languages.length</span>
